import { FileText, Calendar, MapPin, ArrowLeft, AlertCircle, CheckCircle, Clock } from 'lucide-react';
                                            ...
                                            <div className="mb-3">
                                                ...
                                                {Array.isArray(report.symptoms) && report.symptoms.length > 0 ? (
                                                    <div className="flex flex-wrap gap-1">
                                                        {report.symptoms.map((symptom: any, idx: number) => {
                                                            // Normalize symptom to string
                                                            const symptomText =
                                                            ...
                                                            return (
                                                                <span
                                                                    key={`${report.id}-symptom-${idx}`}
                                                                    className="px-2 py-0.5 bg-blue-50 text-blue-700 text-xs rounded"
                                                                >
                                                                    {symptomText.replaceAll("-", " ")}
                                                                </span>
                                                            );
                                                        })}
                                                    </div>
